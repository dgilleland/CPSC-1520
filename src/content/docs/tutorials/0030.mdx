...
We've created a simple web page, and if you've done something like this before, then it should feel pretty self-explanatory.

## Exploring the DOM

In this part, we will begin exploring our web page using JavaScript.
...
1. You should see the following in the terminal. If you hover your mouse over this result, you should see that the browser highlights the corresponding element in the browser.
   ...
   <Aside>
   You might think that the JavaScript is simply giving us our HTML, but *it's not*. It's actually referencing the DOM element. But because we *stopped* typing code by pressing <kbd>Enter</kbd>, it simply presented that DOM element as a *string* (the HTML you just saw.)
   </Aside>
