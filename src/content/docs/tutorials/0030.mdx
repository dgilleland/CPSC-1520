...
How might you build on this tutorial? Continue exploring the use of the `.querySelector()` function in the HTML page you built. Then go and explore how you can use it in the dev console for *any* web page! Lastly, take a look at the [official documentation for the `.querySelector()` method on MDN](https://developer.mozilla.org/en-US/docs/Web/API/Document/querySelector).
