...
1. View the web page in your browser. (See [*Running Web Projects*](/CPSC-1520/guides/0040/) if you don't know how to launch the web server from VS Code.)

   When you see the HTML page in your browser, you should see something like this (it might vary a bit, depending on your browser).
