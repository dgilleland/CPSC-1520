...
In this multi-part tutorial, we'll build a simple script these concepts:

- Variables, values and data types
- Simple math instructions
- Declaring and calling functions

While this is a short journey, it will highlight key aspects that undergird how JavaScript works. As you go through this tutorial, you may want to pause at points to consider the explanatory articles elsewhere on this site. I'll drop a few links in this tutorial, but for a big picture of why we have and need JavaScript, check out the following and then come back here.
...
We've taken big steps in our quickstart on learning how JavaScript works. Review the article below before continuing on to the next part of this QuickStart series.
