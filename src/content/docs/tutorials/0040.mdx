...
## Embeding JavaScript in HTML Files
...
1. Make some observations. What did you expect to see? What did you actually see?
    ...
    ```bash "null" "<h1>​HTML and JavaScript​</h1>​"
    Inside the head tag
