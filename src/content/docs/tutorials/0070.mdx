...
<BeforeAndAfter open base="tutorials/0070/" style="--sl-color-border:orange">
  The goal here is to understand how we can listen for and respond to user interactions on our web pages.
