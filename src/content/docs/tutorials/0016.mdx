...
<details>
    ...
    - Create objects using the `new` keyword and object constructor functions.
    - Access members (properties and functions) of objects using the dot notation.
    - Add new properties to objects dynamically.
    - Describe the role of the `.toString()` method in certain objects such as dates.
    - Create date objects for specific dates.
