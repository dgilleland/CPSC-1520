...
```js "[initializations]" "conditionalExpression" "[incrementations]" "statementOrStatementBlock"
...
<Aside title="Always Use Semicolons in JavaScript" type="caution">
  If you are missing semicolons in your code, most JavaScript engines (like the ones in your browser) will attempt to *interpret* where it thinks the semicolons should go as it is processing your code. This is referred to a **Automatic Semicolon Insertion** (ASI), and it can lead to problems in your code.
...
### Namespace Declaration and Using Statements ⁉️
