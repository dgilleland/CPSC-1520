...
- `==` - General equality ("Is equal to")
- `===` - Strict equality
- `!=` - General inequality ("Not equal to")
- `!==` - Strict inequality
- `>` - Greater Than
...
JavaScript has the following boolean operators. These are sometimes referred to as "Logical Operators".
