...
Anything that is not false (or *falsy*) is regarded as equivalent to `true`. Besides the `true` keywords, some samples of *truthy* values include the following: `42`, `'bob'`, `'\n'`, `{ key: 'value' }`.
