...
- <a href="https://youtu.be/HgNDii20FG4?si=4WDJsfw7zCUxMJ_k" target="_blank">Top 6 HTML Features You’re Not Using (But Should Be)</a> <Icon name="external" class="mb-0 text-orange-500 inline" />
  - 💫 `inert` attribute! 👀
