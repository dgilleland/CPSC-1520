...
import { Aside, Badge, Steps, FileTree } from '@astrojs/starlight/components';
...
If you are unsure of where to find what you're looking for, then use the built-in search (<kbd>Ctrl</kbd> + <kbd>k</kbd>). It's pretty good, and is part of the [Astro Starlight](https://starlight.astro.build) framework this site is built on.
