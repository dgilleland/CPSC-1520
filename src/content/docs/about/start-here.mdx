...
<Aside type="caution">
This site is *temporary*, so don't expect any bookmarks to work after December 2025. I am, however, planning on taking the work done here and publishing it into a longer-lived site on **Programming Fundamentals for JavaScript/TypeScript**.
</Aside>
...
<Tabs>
  ...
  Your classes are on **Monday** (online), **Wednesday**, and **Friday**. As students in the *Computer Software Development* career path, you have already taken *Programming Fundamentals*. Check out the `Agenda.md` file in Dan's Instructor Workbook:
  ...
  Your classes are on **Monday** (online), **Tuesday**, and **Friday**. As students in the *Computer Software Development* career path, you have already taken *Programming Fundamentals*. Check out the `Agenda.md` file in Dan's Instructor Workbook:
