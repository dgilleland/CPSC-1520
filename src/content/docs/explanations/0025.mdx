...
The following code illustrates Simple Sequence. It's a step-by-step approach to calculate the perimeter of a rectangle. Here, we're making our steps ultra-small, to illustrate the sequence.
