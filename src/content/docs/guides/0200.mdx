...
1. ✨ VS Code should prompt you with a notification that says "Would you like to save a configuration in your launch.json for easy access later?" Click **Yes**.
    ...
    - If no notification appears or you accidentally choose "Never", check the **troubleshooting** page for help.
    
      Alternatively, you can manually create the `.vscode/launch.json` file using the settings below.
1. 🚀 You should have a `launch.json` file under a `.vscode` folder with the following settings.
