...
<Aside type="tip" title="Further Reading">
   ...
   <LinkButton href="https://medium.com/front-end-weekly/how-to-write-good-git-commit-messages-like-a-pro-2c12f01569d9" target="_blank" icon='external'>How to Write Good Git Commit Messages like a pro</LinkButton>

   <LinkButton href="https://www.freecodecamp.org/news/how-to-write-better-git-commit-messages/" target="_blank" icon='external'>How to Write Better Git Commit Messages</LinkButton>

   <LinkButton href="https://www.pullrequest.com/blog/mastering-the-art-of-git-commit-messages/" target="_blank" icon='external'>Writing Effective Commit Messages in Git: Best Practices and Examples</LinkButton>
</Aside>
